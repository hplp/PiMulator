...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins Bank_0/s_axi_Bank] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net Bank_0_interrupt [get_bd_pins Bank_0/interrupt] [get_bd_pins processing_system7_0/IRQ_F2P]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Bank_0/s_axi_Bank/Reg] SEG_Bank_0_Reg
