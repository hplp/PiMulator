...
#
# test0.tcl: Tcl script for re-creating project 'Zynq_DRAM2'
#
# Generated by Vivado on Thu Aug 08 12:06:00 -0400 2019
...
#
# 1. This project restoration tcl script (test0.tcl) that was generated.
#
...
set orig_proj_dir "[file normalize "$origin_dir/../../../../Vivaldo/Zynq_DRAM2"]"
...
proc cr_bd_design_1 { parentCell } {
  ...
  set Bank_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:Bank:1.0 Bank_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins Bank_0/s_axi_BankBundle] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Bank_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins Bank_0/ap_rst_n] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Bank_0/s_axi_BankBundle/Reg] SEG_Bank_0_Reg
