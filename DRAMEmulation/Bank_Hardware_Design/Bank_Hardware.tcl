#*****************************************************************************************
# Initially generated with Vivado (TM) v2018.3.1 (64-bit)
#
# Bank_Hardware.tcl: Tcl script for re-creating project 'Bank_Hardware'
#
#*****************************************************************************************
...
set _xil_proj_name_ "Bank_Hardware"

variable script_file
set script_file "Bank_Hardware.tcl"
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../Bank_HLS/Bank_HLS"]" $obj
...
# Create block design
source $origin_dir/bd_src/pynqz1.tcl
...
set file "pynqz1/pynqz1.bd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "registered_with_manager" -value "1" -objects $file_obj

# Set 'sources_1' fileset properties
set obj [get_filesets sources_1]
set_property -name "top" -value "pynqz1_wrapper" -objects $obj
...
launch_runs -jobs 32 impl_1 -to_step write_bitstream
wait_on_run impl_1
puts "Implementation done!"
write_hwdef -force $origin_dir/${_xil_proj_name_}/Bank_Hardware.sdk/pynqz1_wrapper.hwdef
