...
set rc [catch {
  ...
  set_property webtalk.parent_dir D:/VMEC/Vivaldo/Zynq_DRAM2/Zynq_DRAM2.cache/wt [current_project]
  set_property parent.project_path D:/VMEC/Vivaldo/Zynq_DRAM2/Zynq_DRAM2.xpr [current_project]
  set_property ip_repo_paths d:/VMEC/Git/PiMulator/DRAMEmulation/Bank_HLS/Bank_HLS [current_project]
  update_ip_catalog
  set_property ip_output_repo D:/VMEC/Vivaldo/Zynq_DRAM2/Zynq_DRAM2.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
  add_files -quiet D:/VMEC/Vivaldo/Zynq_DRAM2/Zynq_DRAM2.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files D:/VMEC/Vivaldo/Zynq_DRAM2/Zynq_DRAM2.srcs/sources_1/bd/design_1/design_1.bd
